...
public final class view_005fbills_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li><a class=\"active-menu\" href=\"view_bills.jsp\">View\r\n");
      out.write("\t\t\t\t\t\t\t\tBill</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t");
						...
						String all_bills = "select * from "+bill;
						ps = con.prepareStatement(all_bills);
						ResultSet resultset_bill = ps.executeQuery();
...
while(resultset_bill.next())
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(resultset_bill.getString(1) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(resultset_bill.getInt(4) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(resultset_bill.getInt(5) );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><a href='index.html?id=");
      out.print(resultset_bill.getString(1) );
      out.write("'><button type=\"button\">Pay Bill</button></a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
