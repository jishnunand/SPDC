							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover">
										...
										{%>
											<tr>
												<td><%=resultset_bill.getString(1) %></td>
												<td><%=resultset_bill.getInt(4) %></td>
												<td><%=resultset_bill.getInt(5) %></td>
												<td><a href='index.html?id=<%=resultset_bill.getString(1) %>'><button type="button">Pay Bill</button></a></td>
											</tr>
										<%
										}
										%>
