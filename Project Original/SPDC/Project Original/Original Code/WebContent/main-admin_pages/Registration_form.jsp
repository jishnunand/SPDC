                    ...
                    <div class="col-md-6">
                       ...
                       <form action="Registration.jsp" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter GSM-ID" name="gsm_id" />
                          </div>
                          
                          <hr />
                          <label for="exampleInputmobileno">MOBILE-NO</label>
                            <input type="text" class="form-control" id="exampleInputmobileno" placeholder="Enter MOBILE-NO" name="mob" />
                          <hr/>
