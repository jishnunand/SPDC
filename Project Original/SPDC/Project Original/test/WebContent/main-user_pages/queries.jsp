        ...
        <nav  class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="queries.jsp">Send Queries</a>
                    </li>
                    ...
                    <div class="col-md-6">
                       ...
                       <form>
                          <div class="form-group">
                            ...
                            <input type="texts" class="form-control" id="exampleInputEmail1" placeholder="Enter the Subject" />
                          </div>
                          
                          <hr />
                          <textarea class="form-control" rows="3" placeholder="Enter your Valueable feedback"></textarea>
                          <hr/>
