            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <form action="admin_creation.jsp" method="post">
                          <div class="form-group">
                            <label for="exampleInputEmail1">Username</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter the Admin UserName" name="username" required/>
                          </div>
                          
                          <div class="form-group">
                            <label for="exampleInputEmail1">Mobile Number</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter the Mobile Number" name="mobile_number"value="+91" required/>
                          </div>
