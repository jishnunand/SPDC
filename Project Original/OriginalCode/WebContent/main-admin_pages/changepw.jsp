...
<%	//taking from change password.jsp
	...
	//Queries
	String query_find_user_details = "select * from SPDC_ADMIN where username=?";
	String query_update_password = "update SPDC_ADMIN set password=? where username=?";
    ...
    if(!new_password.equals(repeat_password))
    {
    	out.write("<script type='text/javascript'>\n");
  		...
  		out.write("window.location.href='http://localhost:9895/Original_Code/main-admin_pages/change_password.jsp';");
  		out.write("</script>\n");
    }
