...
<body>
	<div id="wrapper">
		...
		Connection con = DriverManager.getConnection(
			...
			String all_queries = "select * from SPDC_QUERIES";
									...
									{%>
										<tr>
											<td><input type="checkbox" name="checkbox"
												id=<%=resultset_queries.getInt(1) %> value="value"></td>
											<td><%=resultset_queries.getString(2) %></td>
											<td><%=resultset_queries.getString(3) %></td>
											<td><%=resultset_queries.getString(4) %></td>
											<td><%=resultset_queries.getString(5) %></td>
											<td><a href='queries_main_replay.jsp?gsm_id=<%=resultset_queries.getString(1) %>'><button type="button">Replay</button></a></td>
										</tr>
										<%
										}
										%>
