                    ...
                    <div class="col-md-6">
                       ...
                       <form action="Registration.jsp" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter GSM-ID" value="+91" name="gsm_id" />
                          </div>
                          
                          <hr />
                          <label for="exampleInputmobileno">MOBILE-NO</label>
                            <input type="text" class="form-control" id="exampleInputmobileno" placeholder="Enter MOBILE-NO" value="+91" name="mob" />
                          <hr/>
