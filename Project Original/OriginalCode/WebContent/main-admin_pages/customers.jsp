...
<body>
	<div id="wrapper">
		...
		Connection con = DriverManager.getConnection(
			...
			String all_queries = "select * from SPDC_USER_PROFILE";
									...
									{%>
										<tr>
											<td><input type="checkbox" name="checkbox"
												id=<%=resultset_queries.getString(1) %> value="value"></td>
											<td><%=resultset_queries.getString(1) %></td>
											<td><%=resultset_queries.getString(3) %></td>
											<td><%=resultset_queries.getString(5) %></td>
											<td><%=resultset_queries.getString(7) %></td>
											<td><%=resultset_queries.getString(8) %></td>
											<td><%=resultset_queries.getString(9) %></td>
											<td><a href='queries_main_replay.jsp?gsm_id=<%=resultset_queries.getString(1) %>'><button type="button">View</a></td>
										</tr>
										<%
										}
										%>
