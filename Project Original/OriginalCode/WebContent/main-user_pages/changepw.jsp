                    ...
                    <div class="col-md-6">
                       ...
                       <form action="change_password.jsp" method="post">
                          ...
                          <label for="exampleInputmobileno">New Password</label>
                            <input type="text" class="form-control" id="exampleInputmobileno" placeholder="Enter new password" name = "new_password"/>
                          <hr/>
                           <label for="exampleInputmobileno">Re-Enter Password</label>
                            <input type="text" class="form-control" id="exampleInputmobileno" placeholder="Enter re-enter password" name = "repeat_password" />
                          <hr/>
