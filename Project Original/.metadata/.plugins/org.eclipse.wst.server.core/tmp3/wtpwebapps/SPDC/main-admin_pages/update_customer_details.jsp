...
String old_gsm,old_mob,old_email = null;
...
//CHECKING GSM-ID WHETHER ITS ALREADY REGISTERED WITH US
	...
	//CHECKING email WHETHER ITS ALREADY REGISTERED WITH US
		...
		if(!old_email.equals(email))
		{
			...
			if (rs.next())
			{
				...
				gsm_flag = 1;
				out.write("<script type='text/javascript'>\n");
				out.write("alert(' Entered Email ID is already exists not able to procced more');\n");
				out.write("window.location.href='http://localhost:9895/SPDC/main-admin_pages/customers.jsp';");
				out.write("</script>\n");
			}
		}
