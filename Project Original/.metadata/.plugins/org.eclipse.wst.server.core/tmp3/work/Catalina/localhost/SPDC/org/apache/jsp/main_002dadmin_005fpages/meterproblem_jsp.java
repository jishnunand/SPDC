...
public final class meterproblem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<span style=\"color:red\">*The Actual Data will be show after 27th of this month</span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"panel-heading\">Customers Details of Meter Issues</div>\r\n");
...
while(rs.next())
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><a href='edit_customers_form.jsp?id=");
      out.print(rs.getInt(1) );
      out.write("'><button type=\"button\">View</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
