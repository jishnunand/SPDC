...
public final class delete_005fcustomer_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ps = connection.prepareStatement("delete from SPDC_ADMIN where id = ?");
ps.setInt(1,id);
ps.execute();
