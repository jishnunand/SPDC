            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-6">
                       ...
                       <form action="edit_profile_submit.jsp" method="post">
                       <%
                       while(rs.next())
                       {
                       %>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter the holder name"  name="customer_name" value="<%=rs.getString(6) %>"/>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your House number" name="house_no" value="<%=rs.getString(8) %>"/>
                          </div>

                          <div class="form-group">
                            <label for="exampleInputEmail1">STREET OR POST</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter the Street/Post" name="post" value="<%=rs.getString(9) %>"/>
                          </div>

                          <div class="form-group">
                            <label for="exampleInputEmail1">TOWN OR CITY</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your town or city" name="town" value="<%=rs.getString(10) %>" />
                          </div>
                          
                          <div class="form-group">
                            <label for="exampleInputEmail1">DISTRICT</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your Country" name="district" value="<%=rs.getString(12) %>"  />
                          </div>

                          <div class="form-group">
                            <label for="exampleInputEmail1">STATE</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your State" name="state" value="<%=rs.getString(12) %>" />
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your Phone number"  name="phone_number" value="<%=rs.getString(5) %>"/>
                          </div>
