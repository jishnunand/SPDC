...
public final class edit_005fcustomers_005fform_jsp extends org.apache.jasper.runtime.HttpJspBase
...
while(rs.next())
      ...
      out.write("\" name=\"connection_type\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t");
...
if(status==true){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
System.out.println("update_customer_details.jsp?id="+id+""); 
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
