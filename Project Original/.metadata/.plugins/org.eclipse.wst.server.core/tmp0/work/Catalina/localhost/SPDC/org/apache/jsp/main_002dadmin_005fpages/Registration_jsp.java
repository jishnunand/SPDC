    ...
    try {
      ...
      out.write("\t\t");
		...
		+"user=root&password=jishnu");
  		...
  		String gsm="+91"+request.getParameter("gsm_id");
  		String mob="+91"+request.getParameter("mob");
    	...
    	//SAVING CUSTOMER DETAILS TO DB
  		...
  		{	  
	  		...
	  		{  
				...
				String insert_data="insert into SPDC_USER_PROFILE (GSM_ID,PASSWORD,MOBILE_NUMBER,CONNECTION_TYPE) values(?,?,?,?)";
