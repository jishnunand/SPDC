                    ...
                    <div class="col-md-6">
                       ...
                       <form action="edit_profile_update.jsp" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="username" id="exampleInputEmail1" placeholder="Enter the Device id"  value="<%=rs.getString(2)%>" required/>
                          </div>
                          
                          <div class="form-group">
                            <label for="exampleInputEmail1">MOBILE NUMBER</label>
                            <input type="text" name="mobile" class="form-control" id="exampleInputEmail1" placeholder="Enter the holder name" value='<%=rs.getString(4)%>' required />
                          </div>
                           
                           <div class="form-group">
                            <label for="exampleInputEmail1">EMAIL</label>
                            <input type="Email" class="form-control" name="email" id="exampleInputEmail1"  value="<%=rs.getString(5)%>" required />
                          </div>
