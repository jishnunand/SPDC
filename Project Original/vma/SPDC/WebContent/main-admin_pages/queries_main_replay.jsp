								...
								<div class="col-md-6">
									<div class="panel panel-default">
										...
										{%>
											...
											<form action="query_reply_db.jsp" method="post">
											
												<div class="form-group">
													<input type="hidden" value=<%=rs.getInt(1)%> name="id">
													<label for="exampleInputEmail1">GSM ID</label>
													 <input type="text" value=<%=rs.getString(2)%> class="form-control" id="exampleInputEmail1"/>
												</div>

												<hr />
												<textarea class="form-control" rows="6"
													placeholder="Enter your Valueable feedback" name="msg"></textarea>
												<hr />
