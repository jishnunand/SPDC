  ...
  <div class="container_16">
    ...
    <nav>
      <ul>
          ...
          <li><a href="Admin_sell.aspx">Selling</a></li>
          <li><a href="Admin_rent.aspx">Renting</a></li>
          <li><a href="Admin_new.aspx">NewProjects</a></li>
          <li><a href="login.aspx" onclick="return confirm('Are You Sure ?');">LogOut</a></li>
      </ul>
    </nav>
      <div id="faded">
          <div class="rap">
...
<!-- END PAGE SOURCE -->
<div align="center">This website created to--<a href=''>coscorealestategroup.com</a></div>
    <p>
        &nbsp;</p>
</body>
</html>
