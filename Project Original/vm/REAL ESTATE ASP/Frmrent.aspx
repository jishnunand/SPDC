<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Frmrent.aspx.vb" Inherits="Frmrent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <br />
    <center><strong style="font-size: xx-large">Find Properties On Rent</strong></center>
    <br />
    <br />
    <br />
    <br />
