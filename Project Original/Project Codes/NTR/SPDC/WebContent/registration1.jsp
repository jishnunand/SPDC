...
<ul class="nav">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="update.html"><i class="fa fa-user-plus"></i> Edit User Details</a>
                        </li>
                         <li class="divider"></li>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                     ...
                     <li>
                       <a> <strong> Welcome Admin </strong></a>
                    </li>
                    ...
                    <li>
                        <a class="active-menu" href="Registration.html">Registration</a>
                    ...
                    <li>
                        <a  href="queries.html">Read Queries</a>
                    </li>
                    ...
                    <div class="col-md-6">
                       ...
                       <form>
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter GSM-ID" />
                          </div>
                          
                          <hr />
                          <label for="exampleInputmobileno">MOBILE-NO</label>
                            <input type="text" class="form-control" id="exampleInputmobileno" placeholder="Enter MOBILE-NO" />
                          <hr/>
