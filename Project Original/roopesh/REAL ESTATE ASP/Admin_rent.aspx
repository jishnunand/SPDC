lobo<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_rent.aspx.cs" Inherits="REAL_ESTATE_ASP.Admin_rent" %>
...
<h1><a href="#"><strong>Cosco</strong> Real Estate</a></h1>
        ...
        <center><strong style="font-size: xx-larRenting Properties
</strong></center>
<div> 
 ...
 <asp:TemplateField HeaderText="Age">
        ...
        <asp:HyperLink ID="HyperLink1" CssClass="buttonLogin" NavigateUrl='<%# Eval("imagepath") %>' Target="_blank" runat="server">Image</asp:HyperLink>
            ...
            <SortedDescendingHeaderStyle BackColor="#002876" />
                ...
                <asp:Button ID="Button1" runat="server" CssClass="buttonLogin" OnClick="Button1_Click" style="top: 149px; left: 1006px; position: absolute; height: 26px; width: 83px" Text="Return" />
