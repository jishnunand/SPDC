<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_new.aspx.cs" Inherits="REAL_ESTATE_ASP.Admin_new" %>
...
<div> 
  <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" style="top: 218px; left: 229px; position: absolute; height: 187px; width: 819px" AllowPaging="True" PageSize="2">
            <Columns>
 ...
 <asp:TemplateField HeaderText="Age">
        ...
        <asp:HyperLink ID="HyperLink1" CssClass="buttonLogin" NavigateUrl='<%# Eval("imagepath") %>' Target="_blank" runat="server">Image</asp:HyperLink>
            ...
            <SortedDescendingHeaderStyle BackColor="#002876" />
                ...
                <asp:Button ID="Button1" runat="server" CssClass="buttonLogin" OnClick="Button1_Click" style="top: 151px; left: 997px; position: absolute; height: 26px; width: 87px" Text="Return" />
