        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (isvalidemailid(inputmail))
                {
                    ...
                    {
                        sdr.Close();
                        cmd.CommandText = "select COUNT(*) from renting where state='" + DropDownList1.SelectedValue + "' and District='" + DropDownList2.SelectedValue + "' and property='" + DropDownList3.SelectedValue + "' and price='" + DropDownList4.SelectedValue + "'";
                        ...
                        else
                        {
                             ...
                             {
                                 cmd.CommandText = "insert into renting(email,state,district,property,price,imagename,imagepath,contact) values(@email,@state,@district,@property,@price,@imagename,@imagepath,@contact)";
